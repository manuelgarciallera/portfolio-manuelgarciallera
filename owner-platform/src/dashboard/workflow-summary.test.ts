...
describe('buildWorkflowSummary', () => {
  ...
  it('rejects impossible workflow totals', () => {
    const input = { artifacts: 2, bundles: 1, figmaImportExecutions: 0, figmaImportPlans: 0, figmaImportReviews: { approved: 0, rejected: 0 }, proposals: { accepted: 0, pending: 0, rejected: 0 }, restores: { confirmed: 0, conflict: 0, executed: 0, ready: 0 }, reviews: { approved: 1, rejected: 1 } }
