...
export const PagePreviewLink = () => {
  ...
  if (collectionSlug === 'preview-snapshots') return id == null ? null : <p><Link href={`/admin/snapshot-preview/${encodeURIComponent(String(id))}`} target="_blank" rel="noopener noreferrer">Ver captura histórica ↗</Link></p>
