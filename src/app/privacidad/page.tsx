...
export default function PrivacyPage() {
  return <main className={styles.page}>
    ...
    <p>La duración de las cookies no equivale a la conservación de los informes: los datos alojados por cada proveedor están sujetos a los plazos de la propiedad y del plan contratado. Los informes agregados de Google no están sujetos al mismo plazo que los eventos individuales. Se utilizan para comparar la evolución del portfolio y revisar sus contenidos, no para identificar personas. Puedes solicitar información sobre los plazos efectivos y la supresión al responsable.</p>
