...
const IcoReplay=({s=24,c="#f5f5f7"})=><svg width={s} height={s} viewBox="0 0 24 24" fill="none"><path d="M19.25 9.55A7.35 7.35 0 1 1 12.05 4.7c2.05 0 3.67.77 5.02 2.08" stroke={c} strokeWidth="2.9" strokeLinecap="round" strokeLinejoin="round"/><path d="M17.45 2.95l4.35 2.18-3.92 2.72-.43-4.9z" fill={c}/></svg>;
