...
.acc-dk{background:linear-gradient(92deg,#d6f0ea 0%,#b7dde2 20%,#8ec2cf 52%,#5f8fb8 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
/* Light bg: near-black â†’ teal dark (readable, professional) */
.acc-lt{background:linear-gradient(92deg,#c9e6e4 0%,#a9d2d8 22%,#83b6c7 55%,#557ea5 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
