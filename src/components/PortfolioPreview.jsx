...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ SPHERE SHADER Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ CSS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
const CSS=`
...
/* Ã¢â€â‚¬Ã¢â€â‚¬ GRADIENTS Ã¢â€â‚¬Ã¢â€â‚¬ */
/* Dark bg: white Ã¢â€ â€™ teal light */
...
/* Light bg: near-black Ã¢â€ â€™ teal dark (readable, professional) */
...
/* Ã¢â€â‚¬Ã¢â€â‚¬ SCROLL REVEALS Ã¢â€â‚¬Ã¢â€â‚¬ */
...
/* Ã¢â€â‚¬Ã¢â€â‚¬ NAVBAR Ã¢â‚¬â€ exacto Apple Ã¢â€â‚¬Ã¢â€â‚¬ */
.nl{
...
/* Light mode nav Ã¢â‚¬â€ FIXED: active = dark, hover = dark blue */
.nl-lt{color:#6e6e73;}
.nl-lt.active{color:#1d1d1f!important;font-weight:600;}
.nl-lt:not(.active):hover{color:#0d2a4a!important;}

/* Ã¢â€â‚¬Ã¢â€â‚¬ BUTTONS Ã¢â‚¬â€ cÃƒÂ¡psulas limpias Ã¢â€â‚¬Ã¢â€â‚¬ */
.btn-blue{
...
/* Ghost buttons Ã¢â‚¬â€ visibles en cualquier fondo */
.btn-ghost-dk{
...
/* Social buttons Ã¢â‚¬â€ always visible pill with icon */
.btn-social{
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ SVG Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ SMART IMAGE Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
export default function Portfolio(){
  ...
  const NAVLINKS=["Trabajo","3D","Sobre mÃƒÂ­","Contacto"];
    ...
    <div ref={wrapRef} className="p" style={{height:"100vh",overflowY:"scroll",overflowX:"hidden",background:C.bg,color:C.text,transition:"background .5s,color .35s",scrollbarWidth:"thin"}}>
      ...
      <nav style={{
        ...
        <div style={{display:"flex",alignItems:"center"}}>
          <span style={{fontSize:15,fontWeight:600,letterSpacing:"-.04em",color:isDark?"#f5f5f7":"#1d1d1f"}}>Manuel GarcÃƒÂ­a Llera</span>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <button onClick={()=>setTheme(t=>t==="dark"?"light":"dark")}
            ...
            {isDark?"Ã¢Ëœâ‚¬Ã¯Â¸Â Claro":"Ã°Å¸Å’â„¢ Oscuro"}
          </button>
        </div>
      </nav>
      ...
      <section style={{height:"calc(100vh - 52px)",minHeight:620,position:"relative",marginTop:-52,overflow:"hidden",display:"flex",alignItems:"center",justifyContent:"center",background:"#000"}}>
        ...
        <div style={{position:"relative",zIndex:10,textAlign:"center",padding:"0 24px",maxWidth:980,width:"100%"}}>
          <p style={{fontSize:13.5,color:"rgba(255,255,255,.62)",letterSpacing:".015em",marginBottom:20,fontWeight:400}}>
            Portfolio Ã‚Â· Manuel GarcÃƒÂ­a Llera
          </p>
          <h1 style={{fontSize:"clamp(50px,8.5vw,98px)",fontWeight:700,lineHeight:1.03,letterSpacing:"-.048em",marginBottom:6}}>
            <span style={{display:"block",color:"#fff"}}>DiseÃƒÂ±o que</span>
            <span style={{display:"block",color:"#fff"}}>piensa en <span className="acc-dk">cÃƒÂ³digo.</span></span>
          </h1>
          <p style={{fontSize:"clamp(17px,1.9vw,20px)",color:"rgba(255,255,255,.7)",lineHeight:1.58,maxWidth:500,margin:"28px auto 44px",fontWeight:400,letterSpacing:"-.015em"}}>
            Visual Design Manager en LALIGA.<br/>UX, producto, 3D arquitectÃƒÂ³nico y full stack.
          </p>
          <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}}>
            <button className="btn-blue">Ver proyectos</button>
            <button className="btn-ghost-dk">MÃƒÂ¡s sobre mÃƒÂ­</button>
          </div>
        </div>
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ FEATURED Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <FeaturedSection isDark={isDark} C={C}/>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ SECTION BLOCK: 3D ARQUITECTURA Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <ArchSection isDark={isDark} C={C} prefRM={prefRM}/>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ MINI PROJECTS Ã¢â‚¬â€ visual separator Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <MiniProjects isDark={isDark} C={C} projects={[PROJECTS[0],PROJECTS[1],PROJECTS[2]]}/>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ SECTION BLOCK: UX / PRODUCT DESIGN Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <UXSection isDark={isDark} C={C} prefRM={prefRM}/>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ MINI PROJECTS Ã¢â‚¬â€ separator Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <MiniProjects isDark={isDark} C={C} projects={[PROJECTS[3],PROJECTS[0],PROJECTS[1]]} alt/>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ SECTION BLOCK: FULL STACK Ã¢â€â‚¬Ã¢â€â‚¬ */}
      <FullStackSection isDark={isDark} C={C} prefRM={prefRM}/>

      {/* Ã¢â€â‚¬Ã¢â€â‚¬ DEVICE Ã¢â€â‚¬Ã¢â€â‚¬ */}
      ...
      <section style={{padding:"150px 28px",textAlign:"center",background:C.ctaBg,transition:"background .5s"}}>
        <div style={{maxWidth:560,margin:"0 auto"}}>
          ...
          <h2 className="rv" style={{transitionDelay:".14s",fontSize:"clamp(34px,6vw,68px)",fontWeight:700,letterSpacing:"-.046em",lineHeight:1.02,marginBottom:20,color:C.ctaText}}>
            Construyamos algo{" "}
            {/* Gradient adapts to background: dark bg (light mode) Ã¢â€ â€™ white/teal; light bg (dark mode) Ã¢â€ â€™ dark/teal */}
          ...
          <p className="rv" style={{transitionDelay:".26s",fontSize:17,lineHeight:1.65,marginBottom:44,fontWeight:400,color:C.ctaTextSec}}>
            Disponible para proyectos de diseÃƒÂ±o, producto y 3D arquitectÃƒÂ³nico.
          </p>
          <div className="rv" style={{transitionDelay:".38s",display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap",alignItems:"center"}}>
            <button className="btn-blue" style={{padding:"13px 28px"}}>Contactar Ã¢â€ â€™</button>
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ FEATURED Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
function FeaturedSection({isDark,C}){
  const [active,setActive]=useState(0);
  const imgRef=useRef(null);
  const items=[
    {label:"UX Ã‚Â· LALIGA",cat:"Product Design",headline:"DiseÃƒÂ±o de",accent:"producto.",sub:"Experiencias digitales para 20 millones de seguidores en todo el mundo.",src:IMGS[0],fb:FBK[0]},
    {label:"3D Ã‚Â· Estadios",cat:"3D Visualization",headline:"Arquitectura",accent:"fotorrealista.",sub:"Modelos SketchUp, visualizaciÃƒÂ³n en UE5 y rendering web interactivo.",src:IMGS[1],fb:FBK[1]},
    {label:"Full Stack",cat:"Development",headline:"Del diseÃƒÂ±o al",accent:"cÃƒÂ³digo.",sub:"Angular, Node.js y MongoDB. Interfaces que funcionan en producciÃƒÂ³n real.",src:IMGS[2],fb:FBK[2]},
    {label:"Branding",cat:"Brand Design",headline:"Identidad visual de",accent:"marca.",sub:"Sistemas de diseÃƒÂ±o coherentes para entidades del deporte global.",src:IMGS[3],fb:FBK[3]},
  ];
    ...
    <section style={{background:isDark?"#0a0a0b":"#f5f5f7",transition:"background .5s"}}>
      <div style={{maxWidth:980,margin:"0 auto",padding:"130px 28px 56px"}}>
        ...
        <h2 className="rv" style={{transitionDelay:".12s",fontSize:"clamp(34px,5.2vw,64px)",fontWeight:700,letterSpacing:"-.042em",lineHeight:1.03}}>
          <span style={{color:C.text}}>El trabajo </span><span className={isDark?"acc-dk":"acc-lt"}>habla por sÃƒÂ­ solo.</span>
        </h2>
      </div>
      <div style={{maxWidth:1200,margin:"0 auto",padding:"0 28px"}}>
        ...
        <div style={{background:isDark?"rgba(255,255,255,.03)":"rgba(0,0,0,.025)",borderRadius:"0 0 20px 20px",border:`1px solid ${isDark?"rgba(255,255,255,.07)":"rgba(0,0,0,.07)"}`,borderTop:"none",padding:"0 28px"}}>
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ ARCH SECTION Ã¢â‚¬â€ drawrange wireframe Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  return(
    <section ref={secRef} style={{padding:"130px 28px",background:isDark?"#0a0a0b":"#f5f5f7",position:"relative",overflow:"hidden",transition:"background .5s"}}>
      ...
      <div style={{maxWidth:980,margin:"0 auto",position:"relative",zIndex:1,display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:"52px 80px",alignItems:"center"}}>
        <div>
          <p className="rv" style={{fontSize:12,color:C.teal,letterSpacing:".1em",textTransform:"uppercase",fontWeight:600,marginBottom:20}}>3D Ã‚Â· Arquitectura</p>
          ...
          <p className="rv2" style={{transitionDelay:".16s",fontSize:17,color:C.textSec,lineHeight:1.72,marginBottom:32}}>
            Pipeline completo desde SketchUp. Modelado arquitectÃƒÂ³nico, baking en Blender, renders estÃƒÂ¡ticos en UE5 y Twinmotion 2025. VisualizaciÃƒÂ³n 3D interactiva para web.
          </p>
          <div className="rv2" style={{transitionDelay:".28s",display:"flex",gap:12,flexWrap:"wrap"}}>
            ...
            <button className={`btn-ghost-${isDark?"dk":"lt"}`}>Pipeline Ã¢â€ â€™</button>
          </div>
        </div>
        <div className="rs" style={{transitionDelay:".1s",borderRadius:18,overflow:"hidden",background:isDark?"#1c1c1e":"#fff",border:`1px solid ${C.divider}`,boxShadow:isDark?"none":"0 4px 24px rgba(0,0,0,.09)"}}>
          ...
          <div style={{padding:"20px 22px 24px"}}>
            <div style={{fontSize:10.5,color:C.teal,letterSpacing:".08em",textTransform:"uppercase",fontWeight:700,marginBottom:8}}>VisualizaciÃƒÂ³n arquitectÃƒÂ³nica</div>
            <div style={{fontSize:17,fontWeight:700,color:C.text,marginBottom:6,letterSpacing:"-.025em"}}>Estadio Ã‚Â· SketchUp Ã¢â€ â€™ UE5</div>
            <div style={{fontSize:13.5,color:C.textSec,letterSpacing:"-.01em"}}>Render fotorrealista 4K Ã‚Â· Lumen GI Ã‚Â· Nanite</div>
          </div>
        </div>
      </div>
    </section>
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ UX SECTION Ã¢â‚¬â€ WebGL curl-noise fluid simulation Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
function UXSection({isDark,C,prefRM}){
  ...
  useEffect(()=>{
    ...
    const init=()=>{
      ...
      pts=Array.from({length:N},(_,i)=>({
        ...
        hx:0,hy:0, // posiciÃƒÂ³n home Ã¢â‚¬â€ se asigna tras crear
        vx:(Math.random()-.5)*.3,
        vy:(Math.random()-.5)*.3,
        r:Math.random()*2.5+2,
      ...
      // guardar posiciÃƒÂ³n inicial como "home"
    ...
    const draw=()=>{
      ...
      pts.forEach((p,i)=>{
        // Ã¢â€â‚¬Ã¢â€â‚¬ CAMPO DE FLUJO orgÃƒÂ¡nico Ã¢â€â‚¬Ã¢â€â‚¬
        const fi=i*0.43;
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ RATÃƒâ€œN: repulsiÃƒÂ³n notable Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        // Ã¢â€â‚¬Ã¢â€â‚¬ RETORNO AL HOME: fuerza suave hacia posiciÃƒÂ³n original Ã¢â€â‚¬Ã¢â€â‚¬
        // Solo actÃƒÂºa cuando se han alejado Ã¢â‚¬â€ no interfiere con la deriva normal
        ...
        // el home deriva muy lentamente con el flujo Ã¢â‚¬â€ no lucha contra ÃƒÂ©l
        if(md>140){
          p.hx+=(p.x-p.hx)*0.004;
          p.hy+=(p.y-p.hy)*0.004;
        }
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ CAPA PROTAGONISTA: bandada que se abre/cierra, muy reactiva al ratÃƒÂ³n Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  useEffect(()=>{
    ...
    const draw=()=>{
      ...
      pts.forEach((p,i)=>{
        ...
        // RATÃƒâ€œN: obstÃƒÂ¡culo potente
        const mdx=p.x-mouse.x,mdy=p.y-mouse.y;
        const md=Math.sqrt(mdx*mdx+mdy*mdy)||1;
        if(md<180){
        ...
        // dibujar Ã¢â‚¬â€ tamaÃƒÂ±o segÃƒÂºn distancia al centro del grupo
        ...
        const rD=(p.r*3.2)*(1-norm*0.78)+p.r*0.6; // centro ~Ãƒâ€”3.2, periferia ~Ãƒâ€”0.6
  ...
  return(
    <section style={{padding:"130px 28px",background:isDark?"#000":"#fff",position:"relative",overflow:"hidden",transition:"background .5s"}}>
      ...
      <div style={{maxWidth:980,margin:"0 auto",position:"relative",zIndex:2,display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:"52px 80px",alignItems:"center"}}>
        <div>
          <p className="rv" style={{fontSize:12,color:C.teal,letterSpacing:".1em",textTransform:"uppercase",fontWeight:600,marginBottom:20}}>UX Ã‚Â· UI Ã‚Â· Product Design</p>
          <div style={{overflow:"hidden",marginBottom:22}}>
            <h2 className="clip-rv" style={{fontSize:"clamp(30px,4.8vw,58px)",fontWeight:700,letterSpacing:"-.04em",lineHeight:1.06}}>
          ...
          <p className="rv2" style={{transitionDelay:".16s",fontSize:17,color:C.textSec,lineHeight:1.72,marginBottom:32}}>
            Once aÃƒÂ±os diseÃƒÂ±ando para millones de personas. MetodologÃƒÂ­as de investigaciÃƒÂ³n aplicadas a productos de alto impacto. LALIGA, deporte global, plataformas de referencia.
          </p>
          <div className="rv2" style={{transitionDelay:".28s",display:"flex",gap:12,flexWrap:"wrap"}}>
            <button className={isDark?"btn-dk":"btn-lt"}>Ver proyectos UX Ã‚Â· UI</button>
            <button className={`btn-ghost-${isDark?"dk":"lt"}`}>MetodologÃƒÂ­a Ã¢â€ â€™</button>
          </div>
        </div>
        <div className="rs" style={{transitionDelay:".1s",borderRadius:18,overflow:"hidden",background:isDark?"#1c1c1e":"#fff",border:`1px solid ${C.divider}`,boxShadow:isDark?"none":"0 4px 24px rgba(0,0,0,.09)"}}>
          <Img src={IMGS[0]} fb={FBK[0]} alt="UX UI LALIGA" style={{height:280}}/>
          <div style={{padding:"20px 22px 24px"}}>
            <div style={{fontSize:10.5,color:C.teal,letterSpacing:".08em",textTransform:"uppercase",fontWeight:700,marginBottom:8}}>Product Design Ã‚Â· LALIGA</div>
            <div style={{fontSize:17,fontWeight:700,color:C.text,marginBottom:6,letterSpacing:"-.025em"}}>App LALIGA Ã‚Â· 20M+ usuarios</div>
            <div style={{fontSize:13.5,color:C.textSec,letterSpacing:"-.01em"}}>UX Research Ã‚Â· Design System Ã‚Â· Prototyping</div>
          </div>
        </div>
      </div>
    </section>
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ FULL STACK SECTION Ã¢â‚¬â€ constellation points Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  return(
    <section style={{padding:"130px 28px",background:isDark?"#0a0a0b":"#f5f5f7",position:"relative",overflow:"hidden",transition:"background .5s"}}>
      ...
      <div style={{maxWidth:980,margin:"0 auto",position:"relative",zIndex:1,display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:"52px 80px",alignItems:"start"}}>
        <div>
          <p className="rv" style={{fontSize:12,color:C.teal,letterSpacing:".1em",textTransform:"uppercase",fontWeight:600,marginBottom:20}}>Full Stack Ã‚Â· Dev</p>
          <div style={{overflow:"hidden",marginBottom:22}}>
            <h2 className="clip-rv" style={{fontSize:"clamp(30px,4.8vw,58px)",fontWeight:700,letterSpacing:"-.04em",lineHeight:1.06}}>
              <span style={{color:C.text}}>Del diseÃƒÂ±o al </span><span className={isDark?"acc-dk":"acc-lt"}>cÃƒÂ³digo real.</span>
            </h2>
          </div>
          <p className="rv2" style={{transitionDelay:".16s",fontSize:17,color:C.textSec,lineHeight:1.72,marginBottom:32}}>
            Angular 17+ con Signals, Node.js, MongoDB y MySQL. Arquitecturas escalables que van de la idea al deploy, integrando 3D y visualizaciÃƒÂ³n interactiva.
          </p>
          <div className="rv2" style={{transitionDelay:".28s",display:"flex",gap:12,flexWrap:"wrap"}}>
            <button className={isDark?"btn-dk":"btn-lt"}>Ver proyectos dev</button>
            <button className={`btn-ghost-${isDark?"dk":"lt"}`}>Stack completo Ã¢â€ â€™</button>
          </div>
        </div>
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ MINI PROJECTS Ã¢â‚¬â€ visual separator Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
const PROJECTS=[
  {id:0,cat:"UX Ã‚Â· Product Design",title:"LALIGA App",sub:"Experiencia para 20M+ usuarios en 150 paÃƒÂ­ses.",tags:["Figma","UX Research"],year:"2023Ã¢â‚¬â€œ24",src:IMGS[0],fb:FBK[0]},
  {id:1,cat:"3D Ã‚Â· Arquitectura",title:"Estadio Render",sub:"SketchUp Ã¢â€ â€™ UE5 Ã¢â€ â€™ fotorrealismo 4K.",tags:["UE5","SketchUp"],year:"2024",src:IMGS[1],fb:FBK[1]},
  ...
  {id:3,cat:"Branding Ã‚Â· Visual",title:"Sistema Identidad",sub:"Brand system para deporte global.",tags:["Brand","Figma"],year:"2022Ã¢â‚¬â€œ24",src:IMGS[3],fb:FBK[3]},
];
      ...
      <div style={{maxWidth:980,margin:"0 auto"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:32}}>
          <p style={{fontSize:12,color:C.textSec,letterSpacing:".08em",textTransform:"uppercase",fontWeight:500}}>
            {alt?"Proyectos destacados":"MÃƒÂ¡s trabajo"}
          </p>
      ...
      <div style={{maxWidth:980,margin:"0 auto"}}>
        ...
        <div ref={wRef} className="rs" style={{position:"relative",height:"clamp(260px,44vw,480px)",borderRadius:20,overflow:"hidden",cursor:"ew-resize",userSelect:"none",border:`1px solid ${C.divider}`,boxShadow:isDark?"0 24px 64px rgba(0,0,0,.5)":"0 24px 64px rgba(0,0,0,.09)"}} onMouseDown={onDown} onTouchStart={onDown}>
          <div style={{position:"absolute",inset:0}}><Img src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1000&q=80" fb="linear-gradient(135deg,#0a1a0a,#1a3520)" alt="UE5 render"/>
            <div style={{position:"absolute",top:14,right:14,padding:"4px 12px",borderRadius:980,background:"rgba(0,0,0,.6)",backdropFilter:"blur(8px)",fontSize:11,color:"#5ec4c8",fontWeight:600}}>UE5 Ã¢â€ â€™</div></div>
          <div style={{position:"absolute",inset:0,clipPath:`inset(0 ${100-pos}% 0 0)`}}>
            ...
            <div style={{position:"absolute",top:14,left:14,padding:"4px 12px",borderRadius:980,background:"rgba(0,0,0,.6)",backdropFilter:"blur(8px)",fontSize:11,color:"rgba(255,255,255,.6)",fontWeight:600}}>Ã¢â€ Â SketchUp</div>
          </div>
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ DEVICE HIPERREALISTA Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  return(
    <section ref={secRef} style={{padding:"130px 28px",background:isDark?"#0a0a0b":"#f5f5f7",transition:"background .5s",overflow:"hidden"}}>
      <div style={{maxWidth:980,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(290px,1fr))",gap:"52px 80px",alignItems:"center"}}>
        <div>
          <p className="rv" style={{fontSize:12,color:C.teal,letterSpacing:".1em",textTransform:"uppercase",fontWeight:600,marginBottom:18}}>UX Ã‚Â· Product Design</p>
          <div style={{overflow:"hidden",marginBottom:20}}><h2 className="clip-rv" style={{fontSize:"clamp(26px,4vw,50px)",fontWeight:700,letterSpacing:"-.036em",lineHeight:1.1}}><span style={{color:C.text}}>DiseÃƒÂ±o que vive<br/>en </span><span className={isDark?"acc-dk":"acc-lt"}>los dedos.</span></h2></div>
          <p className="rv2" style={{transitionDelay:".14s",fontSize:17,color:C.textSec,lineHeight:1.72,marginBottom:34}}>Interfaces intuitivas desde el primer toque. Once aÃƒÂ±os diseÃƒÂ±ando para millones de personas en el deporte global.</p>
          <div className="rv2" style={{transitionDelay:".28s"}}><button className={isDark?"btn-dk":"btn-lt"}>Ver proyectos UX Ã¢â€ â€™</button></div>
        </div>
            ...
            <div style={{width:252,height:530,borderRadius:50,position:"relative",
              ...
              <div style={{width:"100%",height:"100%",borderRadius:42,overflow:"hidden",position:"relative",background:"linear-gradient(168deg,#06060f,#090f22 40%,#0e0816 75%,#06060f)"}}>
                ...
                <div style={{padding:"68px 14px 16px",height:"100%",display:"flex",flexDirection:"column",position:"relative",zIndex:10}}>
                  <div style={{display:"flex",justifyContent:"space-between",marginBottom:14,fontSize:11,color:"rgba(255,255,255,.4)",fontWeight:600}}><span>9:41</span><span style={{fontSize:9}}>Ã¢â€”ÂÃ¢â€”ÂÃ¢â€”ÂÃ¢â€”Â WiFi</span></div>
                  <div style={{fontSize:21,fontWeight:700,color:"#fff",marginBottom:2,letterSpacing:"-.03em"}}>LALIGA</div>
                  <div style={{fontSize:11,color:"rgba(255,255,255,.28)",marginBottom:18}}>Temporada 2025Ã¢â‚¬â€œ26</div>
                  <div style={{borderRadius:14,padding:"13px 14px",marginBottom:10,background:"rgba(94,196,200,.09)",border:"1px solid rgba(94,196,200,.18)"}}>
                    <div style={{fontSize:9.5,color:"#5ec4c8",fontWeight:700,letterSpacing:".07em",marginBottom:7,textTransform:"uppercase"}}>Ã¢Â¬Â¤ En directo</div>
                    <div style={{fontSize:13.5,fontWeight:700,color:"#fff"}}>Real Madrid 2 Ã¢â‚¬â€œ 1 BarÃƒÂ§a</div>
                    <div style={{fontSize:10,color:"rgba(255,255,255,.32)",marginTop:3}}>Min 73' Ã‚Â· Santiago BernabÃƒÂ©u</div>
                  </div>
                  {[{t:"AtlÃƒÂ©tico 1-0 Sevilla",s:"Final",e:"Ã°Å¸â€Â´"},{t:"ClasificaciÃƒÂ³n Ã‚Â· J30",s:"Ver tabla",e:"Ã°Å¸â€œÅ "},{t:"MbappÃƒÂ© Ã¢â‚¬â€ 15 goles",s:"Top goleador",e:"Ã¢Â­Â"}].map((item,i)=>(
