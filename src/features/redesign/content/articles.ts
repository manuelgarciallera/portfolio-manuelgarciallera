...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'El objetivo no es automatizarlo todo', paragraphs: ['Los mejores flujos reservan a la máquina la amplitud y a la persona la dirección. A veces será necesario invertir ese reparto: pedir a la IA una crítica estrecha mientras el humano explora.', 'Diseñar colaboración humano-IA implica diseñar también desacuerdo, revisión, memoria y posibilidad de detenerse.'], related: { href: projectHref('coordination-hub'), label: 'Ver el protocolo humano–IA de Coordination Hub' } },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: 'Reducir sin ocultar', paragraphs: ['Simplificar no significa eliminar complejidad, sino situarla donde pueda ser comprendida y manejada. Una buena interfaz permite actuar sin exigir que la persona conozca toda la arquitectura.', 'El trabajo de producto consiste en decidir qué debe verse ahora, qué puede esperar y qué evidencia necesita cada decisión.'], related: { href: projectHref('laliga-club-operations-hub'), label: 'Explorar roles y estados en el Hub de Clubes' } },
    ],
  },
]
