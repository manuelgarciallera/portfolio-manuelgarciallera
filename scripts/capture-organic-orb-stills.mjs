...
try{
  for(const compact of [false,true])for(const theme of ['dark','light']){
    ...
    source=source.replace('gl.drawArrays(gl.TRIANGLES,0,6);',`gl.uniform1f(gl.getUniformLocation(program,'cameraZoom'),${compact?2.5:2.6});gl.uniform1f(gl.getUniformLocation(program,'verticalOffset'),0);gl.drawArrays(gl.TRIANGLES,0,6);`)
    ...
    const path=`public/art/hero-organic-waves-${compact?'mobile-':''}${theme}.png`
